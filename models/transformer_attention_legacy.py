...
class EncoderLayer(nn.Module):
    def __init__(self, embedding_dim, num_heads, ff_dim=1024, dropout=0.1):
...
class Transformer(nn.Module):
    def __init__(self, source_max_seq_len, embedding_dim, num_heads, num_layers, dropout=0.1):
        ...
        self.encoder = Encoder(embedding_dim, source_max_seq_len, num_heads, num_layers, dropout)
...
#         self.num_heads = num_heads
#         self.embedding_dim = embedding_dim
#         self.layers = nn.ModuleList([DecoderLayer(embedding_dim, num_heads, embedding_dim, dropout) for _ in range(num_layers)])
#         self.norm = Norm(embedding_dim)
#         self.position_embedding = PositionalEncoder(embedding_dim, max_seq_len, dropout)
...
# # Transformer decoder layer
# class DecoderLayer(nn.Module):
#     def __init__(self, embedding_dim, num_heads, embedding_dim=embedding_dim, dropout=0.1):
#         super(DecoderLayer, self).__init__()
#         self.self_attention = MultiHeadAttention(embedding_dim, num_heads, dropout)
#         self.encoder_attention = MultiHeadAttention(embedding_dim, num_heads, dropout)
#         self.feed_forward = nn.Sequential(
